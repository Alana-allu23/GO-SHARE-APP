...
class _h1State extends State<h1> {
  ...
  Future<dynamic> getdata() async {
    ...
    var response =
        await post(Uri.parse("${con.url}login/profile.php"), body: data);
          ...
          child: ListView(
            children: [
              ...
              InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => GrouptripView()));
                },
                child: ListTile(
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Image(
                  image: AssetImage('assets/login/c.png'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
                ...
                child: OutlinedButton(
                  style: ButtonStyle(
                      side: MaterialStateProperty.all(
                          BorderSide(color: Color(0xff068DA9)))),
                  onPressed: () {
                    Navigator.push(
                        context, MaterialPageRoute(builder: (context) => c1()));
            ...
            Padding(
              ...
              child: Container(
                ...
                child: OutlinedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => gm1()));
                  },
                  child: Text(
                    'Goods Movement',
                    style: TextStyle(color: Color(0xff068DA9), fontSize: 22),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: OutlinedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        context, MaterialPageRoute(builder: (context) => r1()));
                  },
                  child: Text(
                    'Rental Service',
                    style: TextStyle(color: Color(0xff068DA9), fontSize: 22),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: OutlinedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => gt1()));
                  },
                  child: Text(
                    'Group Trip',
                    style: TextStyle(color: Color(0xff068DA9), fontSize: 22),
